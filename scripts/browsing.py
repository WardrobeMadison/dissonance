...
from dissonance import  init_log, io, viewer, analysis
...
AdaptingSteps = Params(
    name="AdaptingSteps",
    filter_path=Path(
        "~/Projects/analysis/filters/adaptingsteps/adapting_steps_spikes_accounted.txt"),
...
parameters = dict(
    ...
    ExpandingSpots=(["GA1 KO", "GG2 control", "GG2 KO",
                    "GA1 control"], ExpandingSpots),
