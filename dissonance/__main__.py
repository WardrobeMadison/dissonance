...
Saccade = Params(
    name="Saccade",
    filter_path=Path("C:/Users/jfarc/Projects/analysis/filters/saccade/GG2_saccade.txt"),
...
ContrastResponse = Params(
    ...
    filter_path=Path("C:/Users/jfarc/Projects/analysis/filters/contrastresponse/GG2_5000_CRF.txt"),
    protocols=["LedPulse"],
    paramnames=[
        "led",
        "protocolname",
...
GA1Spikes = Params(
    name="GA1Spikes",
    filter_path=Path("C:/Users/jfarc/Projects/analysis/filters/GA1ledpulsespikes/temp_from_other.txt"),
    protocols=["LedPulse"],
    paramnames=[
        "led",
        "protocolname",
...
Inhibition = Params(
    name="Inhibition",
    filter_path=Path("C:/Users/jfarc/Projects/analysis/filters/GG2OFFTledpulseinhibition/arvo.txt"),
    protocols=["LedPulse"],
    paramnames=[
        "led",
        "protocolname",
...
ExpandingSpots = Params(
    name="ExpandingSpots",
    filter_path=Path("C:/Users/jfarc/Projects/analysis/filters/expandingspots/expandingspots.txt"),
...
PairedPulse = Params(
    name="PairedPulse",
    filter_path=Path("C:/Users/jfarc/Projects/analysis/filters/ledpairedpulse/1000r*LedPairPulseFilters.txt"),
...
def open_browsing_window(folders, gui_params):
    try:
...
def browse(paramname: str):
    ...
    open_browsing_window(folders, gui_params)
